...
<title>Sent Roommate Requests - Roommate & Rental Platform</title>
...
<div class="container">
  <h2 class="mb-4"><i class="fa-solid fa-paper-plane me-2"></i>Your Sent Roommate Requests</h2>

  <?php if ($result->num_rows > 0): ?>
    <?php while ($request = $result->fetch_assoc()): ?>
      <div class="request-card">
        <h5>Request to: <?= htmlspecialchars($request['receiver_name']) ?></h5>
